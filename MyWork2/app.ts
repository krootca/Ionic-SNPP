window.onload=function(){
	...
	var btn_clears: HTMLElement = document.getElementById("btn_clears");
	var btn_remove: HTMLElement = document.getElementById("btn_remove");
...
let myString: string = "Hello Teacher";
var myNum: number = 1;
const myBoolean: boolean= true;

oration=`All in one: "${myString}, ${ myNum}, ${ myBoolean }" `
console.log("\n------VARS----------\n"+oration+"\n---------------")
...
let heisenberg:string = myArray[0];
...
console.log(myArray)
console.log("-------NUMBERS-------------")
let myArray_numbers: number[]=[1,2,3,4]
...
var myNames:string[]=["johnny depp", "Amber Heard"]
...
class MyCar{
	...
	public onCar:boolean;

	constructor(name:string,onCar:boolean,doorsopen:boolean,doors?:number){
		this.model="CarlInc";
		this.name=name;
...
let newCar = new MyCar("Rolls-Royce Phatom", true, true, 4);
let newCar2 = new MyCar("FORD", false, true, 2);
let newCar3 = new MyCar("Chevrolet Impala", true, false);
